...
load("/Users/agnes/Desktop/MIXGB-jcgs/Supplement/time/Table3/credit.rda")
...
withNA.df=createNA(credit.df,p=0.3)



#"mice.midastouch"={imp<-mice(withNA.df,m=M,seed=s,method="midastouch",print=T)} error occurs
credit.time<-microbenchmark("mice.default"={imp<-mice(withNA.df,m=M,seed=s,print=T)},
...
save(credit.time,file="/Users/agnes/Desktop/MIXGB-jcgs/Supplement/time/Table3/result/credit.RData")
